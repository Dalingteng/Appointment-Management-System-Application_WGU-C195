...
public class CustomerDao {
    ...
    public int addCustomer(String customerName, String address, String postalCode, String phoneNumber, int divisionId) throws SQLException {
    ...
    public int deleteCustomer(int customerId, String customerName) throws SQLException {
